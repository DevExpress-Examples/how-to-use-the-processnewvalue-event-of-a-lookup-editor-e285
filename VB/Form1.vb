...
Namespace ProcessNewValueSample
	Partial Public Class Form1
		...
		Private Sub LookUpEdit1_ProcessNewValue(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ProcessNewValueEventArgs) Handles LookUpEdit1.ProcessNewValue
			...
			If e.DisplayValue Is Nothing OrElse Edit.NullText.Equals(e.DisplayValue) OrElse String.Empty.Equals(e.DisplayValue) Then
				Return
			End If


			If CInt(Fix(RadioGroup1.EditValue)) = 1 Then
				' solution 1 
				Row = LookupTable.NewRow()
